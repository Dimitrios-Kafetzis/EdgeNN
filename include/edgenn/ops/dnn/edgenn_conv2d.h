...
#ifndef EDGENN_CONV2D_H
#define EDGENN_CONV2D_H
...
size_t edgenn_conv2d_scratch_size(const edgenn_conv2d_params_t *params, const int32_t *input_shape);

#ifdef __cplusplus
}
#endif

#endif /* EDGENN_CONV2D_H */
